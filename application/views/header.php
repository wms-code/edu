    ...
    <div class="header-topbar">
        <div class="container">
            <div class="topbar-left pull-left">
                <div class="email"><a href="#"><i class="topbar-icon fa fa-envelope-o"></i><span>info@velloreacademy.com</span></a></div>
        ...
        <div class="container">
            <div class="header-main-wrapper">
                <div class="navbar-heade">
                    <div class="logo pull-left"><a href="index.html" class="header-logo"><img src="<?php echo base_url() ?>assets/images/logo-color-1.png" alt=""/></a></div>
                    <button type="button" data-toggle="collapse" data-target=".navigation" class="navbar-toggle edugate-navbar"><span class="icon-bar"></span><span class="icon-bar"></span><span class="icon-bar"></span></button>
                </div>
                <nav class="navigation collapse navbar-collapse pull-right">
                    <ul class="nav-links nav navbar-nav">
                    <li  class="active"><a href="index.html" class="main-menu">Home</a></li>
                      ...
                      <li class="dropdown"><a href="javascript:void(0)" class="link-page">Computer Education</a>


                      <ul class="dropdown-menu edugate-dropdown-menu-2">
                      <li><a href="computereduction.html" class="link-page">Computer Education</a></li>
                                        <li><a href="skilldevelopement.html" class="link-page">Skill Developement</a></li>
                                        <li><a href="enterence-exam.html" class="link-page">Entrance Exam Coaching</a></li>
                            </ul>
...
<li><a href="gallery-3column.html" class="main-menu">Gallery</a></li> <li><a href="about-us.html" class="main-menu">About Us</a></li>
